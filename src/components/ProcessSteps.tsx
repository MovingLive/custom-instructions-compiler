import { ArrowRight, ClipboardPaste, Cog, Download, FileCheck } from 'lucide-react';
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 transition-colors">
      ...
      <div className="grid grid-cols-1 md:grid-cols-7 gap-4">
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-sm font-medium dark:text-gray-200">1. Select MD Files</p>
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-sm font-medium dark:text-gray-200">2. Download Instructions</p>
        </div>
        <div className="hidden md:flex items-center justify-center">
          <ArrowRight className="w-5 h-5 text-gray-400 dark:text-gray-500" />
        </div>
        <div className="flex flex-col items-center text-center">
          ...
          <p className="text-sm font-medium dark:text-gray-200">3. Put in your workspace</p>
        </div>
        <div className="hidden md:flex items-center justify-center">
          <ArrowRight className="w-5 h-5 text-gray-400 dark:text-gray-500" />
        </div>
